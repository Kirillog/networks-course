...
2. Какому устройству соответствует значение Ethernet-адреса?
   ...
   - сетевой карте моего компьютера: wlp3s0: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc mq state UP mode DORMANT group default qlen 1000
   link/ether 04:92:26:1e:82:1b brd ff:ff:ff:ff:ff:ff
...
1. Каковы шестнадцатеричные значения исходного и конечного адресов в Ethernet-кадре,
   ...
   - Source: dc:f5:05:52:17:09, Destination: ff:ff:ff:ff:ff:ff (broadcast)

![alt text](images/image-2.png)

2. Содержится ли в ARP-сообщении IP-адрес отправителя?
   - Да, 192.168.0.110 в данном случае
...
4. Где в сообщении с ARP-откликом хранится Ethernet-адрес, который мы запрашивали на
   ...
   - Target Mac-Address: dc:f5:05:52:17:09
...
#### Демонстрация работы
See Lab14.postman_test_run.json for Postman tests results
