...
1. Выберите один UDP-пакет. По этому пакету определите, сколько полей содержит UDP-заголовок.
   ![](images/image.png)
   - Source Port, Destination Port, Length и Checksum.
...
3. Значение в поле Length (Длина) – это длина чего?
   - Длина в байтах UDP заголовка и UDP данных.
4. Какое максимальное количество байт может быть включено в полезную нагрузку UDP-пакета?
   - Так как под поле Length отведено 16 бит, то $2^{16} - 1$ максимальная длина всей датаграммы, затем учтем заголовок (8 байт) и заголовок (20 байт) низлежащего IP протокола, и получим $2^{16} - 1 - 8 - 20 = 65507$ байт.
