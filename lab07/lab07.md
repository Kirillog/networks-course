...
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - 0 (3041305522)
   - 1 (4128187732)
   - Все пакеты до 4128187731 включительно сервер получил, ожидает 4128187731 + 1 пакет
   - Выставлены SYN и ACK флаги
...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент
   ...
   - 1 (4128187732), 638 (4128188369), 2094 (4128189825), 3550 (4128191281), 5006 (4128192737), 6462 (4128194193)
   - Времена относительно первого пакета:
      0.155263105, 0.155405413, 0.155423186, 0.155451429, 0.155471417, 0.155510270
   -  0.294837418, 0.294970105, 0.294979535, 0.295065057, 0.      295094762, 0.295103692
   -  0.139574313, 0.139564692, 0.139556349, 0.139613628, 0.139623345, 0.139593422
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - 460327.33973890037 байт/сек
   - TCP Window Size разделим на среднюю RTT = 64256 / 0.13958762483333334
