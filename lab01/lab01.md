...
2. Какие языки (если есть) ваш браузер может принимать? В захваченном сеансе какую еще
   ...
   - В User-Agent еще можно узнать оконную систему (x11), операционную систему (Linux), архитектуру процессора (x86_64) и многое другое
   ![](image-2.png)
...
3. Теперь проверьте содержимое второго HTTP-запроса GET (из вашего браузера на сторону
   ...
   - Да, Tue, 20 Feb 2024 06:59:02 GMT, т. е. требуется вернуть страничку, если была модифицирована с этой даты
   ![](image-9.png)
...
2. Можете ли вы сказать, загрузил ли ваш браузер два изображения последовательно или
   ...
   - Запросы были сделаны асинхронно, а когда пришел ответ от сервера, картинки подгрузились параллельно
